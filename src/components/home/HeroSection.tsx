...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-[#0732C5] via-[#016CF3] to-[#0732C5] pb-16 sm:pb-0">
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        >
          <h1 className="font-display text-7xl font-bold mb-8 text-white leading-tight">
            Hosting der
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#016CF3] to-white"> nächsten </span>
            Generation
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <Link 
              ...
              className="bg-white text-[#0732C5] px-8 py-4 rounded-lg font-semibold flex items-center justify-center group hover:bg-[#016CF3] hover:text-white transition-all duration-300"
            >
