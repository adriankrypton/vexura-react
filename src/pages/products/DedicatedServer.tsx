    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      ...
      <div className="container mx-auto px-4 -mt-12 relative z-10">
        <LocationSelector
          ...
          className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 mb-16"
        />
      </div>
          ...
          {getPackages(selectedLocation).map((pkg, index) => (
            <motion.div
              ...
              className={`relative bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border-2 ${
                pkg.name === 'Enterprise' ? 'border-primary dark:border-primary-light' : 'border-gray-100 dark:border-gray-700'
              }`}
            >
              {pkg.name === 'Enterprise' && (
              ...
              <h3 className="text-2xl font-semibold mb-4 dark:text-white">{pkg.name}</h3>
              <div className="text-3xl font-bold mb-6 text-primary dark:text-primary-light">
                {pkg.price} €<span className="text-sm font-normal text-gray-600 dark:text-gray-400">/Monat</span>
              </div>
              <ul className="space-y-3 mb-6">
                <li className="flex items-center dark:text-gray-300">
                  <Cpu className="h-5 w-5 text-primary dark:text-primary-light mr-2" />
                  {pkg.cpu}
                </li>
                <li className="flex items-center dark:text-gray-300">
                  <Server className="h-5 w-5 text-primary dark:text-primary-light mr-2" />
                  {pkg.cores}
                </li>
                <li className="flex items-center dark:text-gray-300">
                ...
                <li className="flex items-center dark:text-gray-300">
                  <Gauge className="h-5 w-5 text-primary dark:text-primary-light mr-2" />
                  {pkg.bandwidth}
                </li>
              </ul>
