        ...
        <div className="max-w-none space-y-8">
          <div>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-2xl font-semibold mb-4">Widerrufsrecht</h3>
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-4">Folgen des Widerrufs</h3>
                <p className="text-gray-700">
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-4">Ausnahmen vom Widerrufsrecht</h3>
                <p className="text-gray-700 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-4">Muster-Widerrufsformular</h3>
                <p className="text-gray-700 mb-4">
